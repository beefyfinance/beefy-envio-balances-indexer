...
describe('event', () => {
    const chainId = 8453;
    const trxHashStr = '0x5a4fbda772ea9a1754da8fff90de60da9fb2acb06432ea0c9a7cd8719c05443d';
    const trxHash = toBytes(trxHashStr);
    const trxIndex = 6;
    const logIndex = 22;
    ...
    it('Should normalize checksum hashes on the way in', () => {
        const upper = toBytes('0x5A4FBDA772EA9A1754DA8FFF90DE60DA9FB2ACB06432EA0C9A7CD8719C05443D');
    ...
    it('Should produce getEventFields matching entity event id format', () => {
        ...
        expect(toHex(fields.trxHash)).toBe(trxHashStr);
        expect(fields.trxHash).toEqual(toBytes(trxHashStr));
