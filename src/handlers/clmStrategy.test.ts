...
import { FACTORIES, registerClmStrategy } from './testFixtures/register';
    ...
    describe('Initialized event', () => {
        it('Should create ClmStrategy entity when Initialized event is emitted', async () => {
            ...
            const trace = await indexer.process({
                chains: {
                    8453: {
                        simulate: [...initBaseClmSim({ blockNum, timestampSec })],
                    },
                },
            });
                      ...
                      "sets": [
                        {
                          ...
                          "underlyingIdleAmount0": "0",
                          "underlyingIdleAmount1": "0",
                          "underlyingLockedAmount0": "0",
                          "underlyingLockedAmount1": "0",
        ...
        it('Should handle already initialized ClmStrategy gracefully', async () => {
            ...
            const trace = await indexer.process({
                chains: {
                    8453: {
                        simulate: [
                            ...initBaseClmSim({ blockNum, timestampSec }),
                            {
                                contract: 'ClmStrategy',
                                event: 'Initialized',
        ...
        it('Should initialize the parent ClmManager when strategy Initialized fires first', async () => {
            const indexer = createTestIndexer();
            ...
            expect(trace.changes.length).toBeGreaterThan(0);
            expect(trace, 'Should create ClmManager from strategy.vault() and finalize the CLM').toMatchInlineSnapshot(`
              {
                "changes": [
                  {
                    "Clm": {
                      "sets": [
                        {
                          ...
                          "underlyingAltAmount0": "0",
                          "underlyingAltAmount1": "0",
                          "underlyingIdleAmount0": "0.000016736512032194",
                          "underlyingIdleAmount1": "0",
                          "underlyingLockedAmount0": "0",
                          "underlyingLockedAmount1": "0",
                      ...
                      "sets": [
                        {
                          ...
                          "managerToken_id": "8453-0x603492ff8943f5ac69aa69cf09fc96fda2606ee7",
                          "managerTotalSupply": "0.000000001995477855",
                          ...
                          "underlyingAltAmount0": "0",
                          "underlyingAltAmount1": "0",
                          "underlyingIdleAmount0": "0.024215150195868387",
                          "underlyingIdleAmount1": "0",
                          "underlyingLockedAmount0": "0.000052503818585178",
                          "underlyingLockedAmount1": "0.27319",
                      ...
                      "sets": [
                        {
                          ...
                          "trxHash": "0x7e29db7de6b8d447c99f929ab6d2fdb8acf913f66d011e4885293bb0977663d2",
                          "trxIndex": 51,
                          "underlyingAmount0": "0.000000014480795954",
