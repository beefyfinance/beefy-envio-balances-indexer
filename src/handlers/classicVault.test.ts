...
describe('ClassicVault Handlers', () => {
    describe('Initialized event', () => {
        it.skip('Should create ClassicVault entity when Initialized event is emitted', async () => {
        ...
        it.skip('Should handle already initialized ClassicVault gracefully', async () => {
            const indexer = createTestIndexer();
        ...
        it.skip('Should skip blacklisted ClassicVault during initialization', async () => {
            const indexer = createTestIndexer();
