...
import type { ChainOracleConfig } from './types';

const DEFAULT_CHAINLINK_FEED_DECIMALS = 8;
const DEFAULT_UMBRELLA_FEED_DECIMALS = 8;
const DEFAULT_UMBRELLA_REGISTRY = '0x4A28406ECe8FfD7A91789738A5AC15DAC44bfA1B' as Hex;
const DEFAULT_UMBRELLA_FEED_NAME = '0xd2a0ad2667ba45a57ce6a98d6f51a4a4d256d704f578b3b90d7ee12e2f6af854' as Hex;
...
export const ORACLE_CONFIGS: Record<EvmChainId, ChainOracleConfig> = {
    1: {
        ...
        chainlinkNativePriceFeedAddress: '0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419',
    ...
    143: {
        ...
        ...getBaseConfig(143),
        priceOracleType: 'chainlink',
        chainlinkNativePriceFeedAddress: '0xBcD78f76005B7515837af6b50c7C52BCf73822fb',
        chainlinkNativePriceFeedDecimals: DEFAULT_CHAINLINK_FEED_DECIMALS,
    },
    ...
    324: {
        ...
        ...getBaseConfig(324),
        priceOracleType: 'chainlink',
        chainlinkNativePriceFeedAddress: '0x6D41d1dc818112880b40e26BD6FD347E41008eDA',
        chainlinkNativePriceFeedDecimals: DEFAULT_CHAINLINK_FEED_DECIMALS,
    },
    ...
    999: {
        ...
        ...getBaseConfig(999),
        priceOracleType: 'chainlink',
        chainlinkNativePriceFeedAddress: '0xa8a94Da411425634e3Ed6C331a32ab4fd774aa43',
        chainlinkNativePriceFeedDecimals: DEFAULT_CHAINLINK_FEED_DECIMALS,
    },
    ...
    4326: {
        ...
        ...getBaseConfig(4326),
        priceOracleType: 'chainlink',
        chainlinkNativePriceFeedAddress: '0xcA4e254D95637DE95E2a2F79244b03380d697feD',
        chainlinkNativePriceFeedDecimals: DEFAULT_CHAINLINK_FEED_DECIMALS,
    },
    ...
    43114: {
        ...
        ...getBaseConfig(43114),
        priceOracleType: 'chainlink',
        chainlinkNativePriceFeedAddress: '0x0A77230d17318075983913bC2145DB16C7366156',
        chainlinkNativePriceFeedDecimals: DEFAULT_CHAINLINK_FEED_DECIMALS,
    },
    ...
    534352: {
        // scroll
        ...getBaseConfig(534352),
        priceOracleType: 'chainlink',
        chainlinkNativePriceFeedAddress: '0x6bF14CB0A831078629D993FDeBcB182b21A8774C',
        chainlinkNativePriceFeedDecimals: DEFAULT_CHAINLINK_FEED_DECIMALS,
    },
};
