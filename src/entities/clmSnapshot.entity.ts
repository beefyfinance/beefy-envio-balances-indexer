...
export const getOrCreateClmSnapshot = async ({
    ...
    const snapshot: ClmSnapshot = {
        ...
        underlyingIdleAmount0: previousSnapshot?.underlyingIdleAmount0 ?? BIG_ZERO,
        underlyingIdleAmount1: previousSnapshot?.underlyingIdleAmount1 ?? BIG_ZERO,
        underlyingLockedAmount0: previousSnapshot?.underlyingLockedAmount0 ?? BIG_ZERO,
        underlyingLockedAmount1: previousSnapshot?.underlyingLockedAmount1 ?? BIG_ZERO,
        underlyingUnharvestedFees0: previousSnapshot?.underlyingUnharvestedFees0 ?? BIG_ZERO,
        underlyingUnharvestedFees1: previousSnapshot?.underlyingUnharvestedFees1 ?? BIG_ZERO,
