...
const emptyClmStats = () => ({
    ...
    underlyingIdleAmount0: BIG_ZERO,
    underlyingIdleAmount1: BIG_ZERO,
    underlyingLockedAmount0: BIG_ZERO,
    underlyingLockedAmount1: BIG_ZERO,
    underlyingUnharvestedFees0: BIG_ZERO,
    underlyingUnharvestedFees1: BIG_ZERO,
...
export const clmStatsFromState = (state: ClmState) => ({
    ...
    underlyingIdleAmount0: state.underlyingIdleAmount0,
    underlyingIdleAmount1: state.underlyingIdleAmount1,
    underlyingLockedAmount0: state.underlyingLockedAmount0,
    underlyingLockedAmount1: state.underlyingLockedAmount1,
    underlyingUnharvestedFees0: state.underlyingUnharvestedFees0,
    underlyingUnharvestedFees1: state.underlyingUnharvestedFees1,
